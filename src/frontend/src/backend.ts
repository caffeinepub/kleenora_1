...
export class Backend implements backendInterface {
    ...
    async clearProducts(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.clearProducts();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getProductsInRange(arg0: bigint, arg1: bigint): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProductsInRange(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
